...
1. Upload the plugin files to the `/wp-content/plugins/woocommerce-hide-coupon-name` directory, or install the plugin through the WordPress plugins screen directly.
